...
from flash_zones import lookup_zone, zone_surcharge_by_weight, spx_surcharge, thai_post_special_surcharge, dhl_remote_surcharge, kex_bulky_remote_surcharge
import calc_logic
...
_FLASH_THUNDER_SIZE_CM = {  # กว้าง+ยาว+สูง รวมสูงสุดต่อน้ำหนัก (ซม.) — เพิ่มทีละ 5ซม./กก. ตั้งแต่
    ...
    # ตารางเดียวกันเป๊ะกับ Flash Pro OK (เทียบทีละแถวแล้วตรงกันหมด 1-50กก.) — ใช้ dict
    # เดียวกันซ้ำสำหรับ flash_pro_ok ใน _CARRIER_DEFS ด้านล่าง ไม่ต้องแยกก็อปปี้
...
_FLASH_PRO_DD_SIZE_CM = {  # เหมือน Thunder ทุก tier ตั้งแต่ 5กก.ขึ้นไป ต่างกันแค่ 1-4กก.
    # (60/60/60/70 แทนที่จะเป็น 80 คงที่) — ยืนยันจากตารางจริงของ Flash Pro DD (2026-08-05)
    1:60,2:60,3:60,4:70,5:80,6:85,7:90,8:95,9:100,10:105,
    11:110,12:115,13:120,14:125,15:130,16:135,17:140,18:145,19:150,20:155,
    21:160,22:165,23:170,24:175,25:180,26:185,27:190,28:195,29:200,30:205,
    31:210,32:215,33:220,34:225,35:230,36:235,37:240,38:245,39:250,40:255,
    41:260,42:265,43:270,44:275,45:280,46:280,47:280,48:280,49:280,50:280,
...
_FLASH_100CM_SIZE_CM = {  # คงที่ 100 ตลอด 1-9กก. (ไม่ไล่ขึ้นทีละ 5cm/kg เหมือนเจ้าอื่นในช่วงนี้)
    # แล้วค่อยไล่ขึ้นแบบเดียวกับ Thunder/Pro DD/Pro OK ตั้งแต่ 10กก. ขึ้นไป — ยืนยันจาก
    # ตารางจริงของ Flash 100CM (2026-08-05)
    1:100,2:100,3:100,4:100,5:100,6:100,7:100,8:100,9:100,10:105,
    11:110,12:115,13:120,14:125,15:130,16:135,17:140,18:145,19:150,20:155,
    21:160,22:165,23:170,24:175,25:180,26:185,27:190,28:195,29:200,30:205,
    31:210,32:215,33:220,34:225,35:230,36:235,37:240,38:245,39:250,40:255,
    41:260,42:265,43:270,44:275,45:280,46:280,47:280,48:280,49:280,50:280,
...
_KEX_SIZE_CM = {  # ต่างจาก Flash — ราคา/ตารางหลักเขียน "ขนาด" คงที่ 180cm ทุกน้ำหนัก (เพดาน
    # บนสุด) แต่เอกสารมีตาราง "เงื่อนไขการเข้ารับ" แยกต่างหาก จำกัดแคบกว่านั้นตามน้ำหนักจริง
    # (คนขับปฏิเสธรับหน้างานได้ถ้าเกิน) — ใช้ตัวจำกัดที่แคบกว่า/ตรงจริงกว่าแทนเพดานเฉยๆ
    # ยืนยันจากเงื่อนไขจริงของ KEX Express บน iShip (2026-08-05), หลัง 20กก. เอกสารไม่ได้
    # แจกแจงต่อ แต่กฎทั่วไประบุ "ไม่เกิน 180 ซม." ตายตัวอยู่แล้ว จึงคงที่ 180 ต่อจนถึง 30กก.
    1:75,2:75,3:75,4:75,5:75,6:75,7:75,8:90,9:90,10:90,
    11:120,12:120,13:120,14:120,15:120,16:180,17:180,18:180,19:180,20:180,
