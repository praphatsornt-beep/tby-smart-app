...
_EXPENSE_CATEGORIES = {
    ...
    "bank_fees": ("🏦 ค่าธรรมเนียมธนาคาร/โอนเงิน", "หักได้เต็มเป็นค่าใช้จ่ายในการดำเนินธุรกิจ"),
    "vehicle_lease": ("🚗 ค่าเช่า/ผ่อนรถ (เช่าซื้อ)",
                       "หักได้ถ้าใช้เพื่อกิจการจริง — รถยนต์นั่งส่วนบุคคลที่เช่าซื้อมีเพดานตามกฎหมาย "
                       "(ไม่เกิน 36,000 บาท/คัน/เดือน) ถ้าใช้ปนส่วนตัวต้องแยกสัดส่วน ให้นักบัญชีช่วยดูเพดาน"),
    "communications": ("📞 ค่าเน็ต/โทรศัพท์",
                        "หักได้เต็มถ้าใช้เพื่อกิจการจริง — เบอร์/เน็ตที่ปนใช้ส่วนตัว สรรพากรอาจให้แยกสัดส่วน"),
    "local_tax": ("📋 ภาษี (ป้าย/ที่ดิน/รถ ฯลฯ)",
                  "ภาษีป้าย ภาษีที่ดินและสิ่งปลูกสร้าง ภาษีรถยนต์ ที่จ่ายเพื่อกิจการ หักได้เต็ม — "
                  "ถ้าเป็นทรัพย์สินส่วนตัวปนธุรกิจต้องแยกสัดส่วน"),
...
def _render_receipt_html(cr: dict, ci: dict, period: str) -> str:
  ...
  *{box-sizing:border-box;margin:0;padding:0;-webkit-print-color-adjust:exact;print-color-adjust:exact}
  body{font-family:'Prompt',sans-serif;background:#eef0f3;padding:24px;color:#1a1a1a}
...
def render():
    try:
        _fin_active = st.pills(" ", _FIN_TABS, key="_fin_active_sub", default=_FIN_TABS[0], label_visibility="collapsed") or _FIN_TABS[0]
