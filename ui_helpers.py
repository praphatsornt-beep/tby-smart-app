...
def _render_cart_card(cart_key: str, products: list, title: str = "บันทึกรายการขาย"):
    ...
    st.markdown(
        ...
        /* ซ่อนปุ่ม +/- แล้ว แต่ input ยังเว้น padding ฝั่งขวาไว้ให้ปุ่มเดิมอยู่ —
           จอแคบ (มือถือ) กล่องเลยเหลือพื้นที่โชว์ตัวเลขแทบไม่พอ ต้องคืน padding นั้น
           มาเอง ไม่งั้นตัวเลขหายไปเลยตอนคอลัมน์ถูกบีบแคบ */
