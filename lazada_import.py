"""Parser สำหรับไฟล์ 'Income Overview' export จาก Lazada Seller Centre (การเงิน >
ใบแจ้งยอดรายได้ > Export) — ต่างจาก Shopee ตรงที่ไฟล์เดียวมีทั้งรายการสินค้าต่อออเดอร์
