...
def render():
    ...
    st.caption("สินค้าขึ้น \"-\" = ยังไม่มีทั้งอีเมลยืนยันออเดอร์และไฟล์ยอดขาย Shopee ของออเดอร์นั้น "
               "(ไม่ใช่ error) — ปกติจะขึ้นเองจากอีเมลยืนยันออเดอร์อยู่แล้ว ถ้ายังไม่ขึ้นค่อยรอไฟล์ยอดขาย "
               "อัปโหลดที่ 🛒 E-commerce → ⚙️ ตั้งค่า/นำเข้าข้อมูล")
    try:
