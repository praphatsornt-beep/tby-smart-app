...
- [ ] `gas_line_webhook.js` — ยืนยันจากผู้ใช้ 2026-09-01: หารหัสสินค้าไม่เจอ **ไม่ต้องตอบกลับอะไรเลย** (ย้อนกลับส่วนที่เพิ่มไปใน item ด้านบน — เดิมตอบ "❌ ไม่พบรหัสสินค้า ..." ตอนพิมพ์ CODE-QTY ชัดเจนแต่หาไม่เจอ ตอนนี้เอาออก กลับไปเงียบเหมือนเดิมทุกกรณี) ลบตัวแปร `notFoundCodes` ที่ไม่ได้ใช้แล้วด้วย — ยังไม่ deploy
