"""Parser สำหรับไฟล์ "รายงานสินค้าคงเหลือปัจจุบัน/มูลค่า" export จากระบบของบริษัท
(.xls แบบ print-layout — หัวรายงาน/รหัสหมวดหมู่/ยอดรวมต่อหมวดปนอยู่ในคอลัมน์เดียวกับ
